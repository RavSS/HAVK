...
/* This is what HAVK's own bootloader passes if it's used instead of GRUB.
/  This should probably be handled by the makefile instead of being here. */
#define HAVK_BOOTLOADER_MAGIC 0x0DEC0DED
