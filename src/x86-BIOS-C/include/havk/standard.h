...
/* Several macros to help with converting sizes. */
#define btog(x) ((size_t) (x) >> 30)
#define btom(x) ((size_t) (x) >> 20)
#define btok(x) ((size_t) (x) >> 10)

#define gtob(x) ((size_t) (x) << 30)
#define mtob(x) ((size_t) (x) << 20)
#define ktob(x) ((size_t) (x) << 10)
